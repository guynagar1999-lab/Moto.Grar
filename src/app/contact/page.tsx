    ...
    <div className="min-h-screen bg-linear-to-br from-gray-900 via-black to-gray-800 pt-16 lg:pt-20">
      ...
      <div className="relative overflow-hidden bg-linear-to-r from-orange-600 to-red-600 py-20">
        ...
        <div className="relative container mx-auto px-4 text-center text-white">
          ...
          >
            אנו כאן לעזור לך בכל שאלה או בקשה
          </motion.p>
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            <Card className="bg-linear-to-br from-gray-900 to-black border-orange-500/30">
              <CardHeader>
                <CardTitle className="text-2xl moto-gradient-text">שלח הודעה</CardTitle>
                <CardDescription className="text-gray-300">
                  מלא את הפרטים ונחזור אליך תוך 5 דקות
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      >
                        ...
                        <option value="rzr">RZR/UTV</option>
                  ...
                  {submitStatus === 'success' && (
                    <div className="flex items-center p-4 bg-green-500/10 border border-green-500/30 rounded-lg">
                      ...
                      <span className="text-green-400">ההודעה נשלחה בהצלחה! נחזור אליך בקרוב.</span>
                    </div>
                  )}
                  ...
                  {submitStatus === 'error' && (
                    <div className="flex items-center p-4 bg-red-500/10 border border-red-500/30 rounded-lg">
                      ...
                      <span className="text-red-400">אירעה שגיאה. אנא נסה שוב או התקשר אלינו.</span>
                    </div>
                  )}
                </form>
              </CardContent>
          ...
          >
            <Card className="bg-linear-to-br from-gray-900 to-black border-orange-500/30">
              <CardHeader>
                <CardTitle className="text-2xl moto-gradient-text">מידע ליצירת קשר</CardTitle>
                <CardDescription className="text-gray-300">
                  בעלים: {ownerName}
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                {contactInfo.map((info, index) => (
                  <div
                    key={index}
                    className={`flex items-center p-4 rounded-lg bg-gray-800/50 cursor-pointer hover:bg-gray-800 transition-colors ${
                      info.action ? 'hover:border-orange-500/30 border border-transparent' : ''
                    }`}
            ...
            <Card className="bg-linear-to-br from-gray-900 to-black border-orange-500/30">
              <CardHeader>
                <CardTitle className="text-xl text-white">שירות מהיר</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-gray-300 text-right">
                  למקרים דחופים, התקשר ישירות או שלח הודעה בוואטסאפ
                </p>
                <div className="flex gap-3">
                  ...
                  <Button
                    ...
                    onClick={() => window.open(generateWhatsAppLink(businessPhone, 'שלום, אני צריך שירות גרירה דחוף'), '_blank')}
                  >
                    WhatsApp
                  </Button>
                </div>
